...
public class SamsungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //recyclerView=findViewById(R.id.rcv_samsung);
        ...
        getProducts("Samsung"); // Gọi phương thức với tên hãng mong muốn
        ...
        adapter.setOnItemClickListener(new AppleAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int productId) {
                Intent intent = new Intent(SamsungActivity.this, ProductDetailActivity.class);
        ...
        backtt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(SamsungActivity.this, MainActivity.class);
                startActivity(it);
            }
        });
    ...
    public void getProducts(String brand) {
        ...
        call.enqueue(new Callback<List<Apple>>() {
            ...
            public void onFailure(Call<List<Apple>> call, Throwable t) {
                Toast.makeText(SamsungActivity.this, "Failed to load products", Toast.LENGTH_SHORT).show();
            }
        });
