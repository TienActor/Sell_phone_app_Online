...
public class XiaomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.rcv_xiaome);

        adapter = new AppleAdapter();
        recyclerView.setAdapter(adapter);
        recyclerView.setLayoutManager(new GridLayoutManager(this, 2));

        getProducts("Xiaomi"); // Gọi phương thức với tên hãng mong muốn
        ...
        adapter.setOnItemClickListener(new AppleAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int productId) {
                Intent intent = new Intent(XiaomeActivity.this, ProductDetailActivity.class);
        ...
        backtt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(XiaomeActivity.this, MainActivity.class);
                startActivity(it);
            }
        });
    }
    ...
    public void getProducts(String brand) {
        ...
        call.enqueue(new Callback<List<Apple>>() {
            ...
            public void onFailure(Call<List<Apple>> call, Throwable t) {
                Toast.makeText(XiaomeActivity.this, "Failed to load products", Toast.LENGTH_SHORT).show();
            }
        });
    }
}