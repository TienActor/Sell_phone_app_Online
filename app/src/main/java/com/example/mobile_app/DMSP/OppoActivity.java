...
public class OppoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.rcv_oppo);

        adapter = new AppleAdapter();
        recyclerView.setAdapter(adapter);
        recyclerView.setLayoutManager(new GridLayoutManager(this, 2));

        getProducts("OPPO"); // Gọi phương thức với tên hãng mong muốn
        ...
        adapter.setOnItemClickListener(new AppleAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int productId) {
                Intent intent = new Intent(OppoActivity.this, ProductDetailActivity.class);
        ...
        backtt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(OppoActivity.this, MainActivity.class);
                startActivity(it);
            }
        });
    }
    ...
    public void getProducts(String brand) {
        ...
        call.enqueue(new Callback<List<Apple>>() {
            ...
            public void onFailure(Call<List<Apple>> call, Throwable t) {
                Toast.makeText(OppoActivity.this, "Failed to load products", Toast.LENGTH_SHORT).show();
            }
        });
    }
}